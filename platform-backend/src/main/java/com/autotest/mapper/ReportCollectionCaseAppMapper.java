...
import com.autotest.domain.ReportCollectionCaseApp;
...
/**
 * MyBatis Mapper：报告集合-App用例步骤与结果
 * 负责 App 用例执行记录的批量写入、查询以及清理操作
 */
@Mapper
public interface ReportCollectionCaseAppMapper {
    /**
     * 批量写入 App 用例执行记录
     * @param reportCollectionCaseApps 记录列表
     */
