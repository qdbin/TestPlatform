...
public enum MenuEnum {
    ...
    public final String icon;             // 菜单图标标识
    public final String path;             // 菜单前端路由
    public final MenuEnum father;         // 父级菜单
    public final PermissionEnum permission; // 访问所需权限
